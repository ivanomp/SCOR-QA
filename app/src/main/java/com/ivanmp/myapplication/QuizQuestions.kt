...
+ AES-GCM and ChaCha20-Poly1305 providing confidentiality and authentication together efficiently.""",
        ...
        questionSets[QuestionCategory.SCOR_PART_3] = mutableListOf(
            Question.MultipleChoice(
                ...
                setOf("A"),
                "Both Cisco ASA and Cisco IOS router with Zone-based policy firewall support High Availability (HA). Zone-Based Policy Firewall drops traffic if it is from a different zone by default. So we cannot say if Cisco IOS router with Zone-Based Policy Firewall allows or denies traffic by default. Cisco ASA drops all traffic by default.",
                "CCNP and CCIE Security Core SCOR 350-701 Official Cert Guide",
            ...
            Question.MultipleChoice(
                ...
                setOf("A"),
                "Device compliance verification ensures that devices meet security requirements including having the latest OS patches installed.",
                "CCNP and CCIE Security Core SCOR 350-701 Official Cert Guide",
                QuestionCategory.SCOR_PART_3
            ),
            Question.MultipleChoice(
            ...
            Question.MultipleChoice(
                ...
                setOf("B", "D"),
                "Rootkit and backdoor are types of Trojan malware attacks. A rootkit is a collection of software tools that enable administrator-level access to a computer or network. A backdoor is a method of bypassing normal authentication or encryption in a product, computer system, or algorithm.",
                "CCNP and CCIE Security Core SCOR 350-701 Official Cert Guide",
                QuestionCategory.SCOR_PART_3
            ),
            Question.MultipleChoice(
            ...
            Question.MultipleChoice(
                ...
                setOf("A"),
                "Cisco ASA Netflow can filter NSEL (Network Security Event Log) events based on traffic patterns.",
                "CCNP and CCIE Security Core SCOR 350-701 Official Cert Guide",
                QuestionCategory.SCOR_PART_3
            ),
            Question.MultipleChoice(
            ...
            Question.MultipleChoice(
                ...
                setOf("A"),
                "Mobile Device Management (MDM) software secures, monitors, manages and supports mobile devices deployed across mobile operators, service providers and enterprises. A typical MDM product consists of a policy server, a mobile device client and an optional inline enforcement point that controls the use of some applications on a mobile device (like email) in the deployed environment.",
                "CCNP and CCIE Security Core SCOR 350-701 Official Cert Guide",
                QuestionCategory.SCOR_PART_3
            ),
            Question.MultipleChoice(
                ...
                setOf("D"),
                "It is not possible to use an asterisk to wildcard a different part of the domain. The following will not work: *.domain.com, subdomain.*.com, sub*.com, domain.*. By configuring domain.com address in the block list, we implied to block *.domain.com/* (all subdomains would be blocked too).",
                "CCNP and CCIE Security Core SCOR 350-701 Official Cert Guide",
                QuestionCategory.SCOR_PART_3
            ),
            Question.MultipleChoice(
                ...
                setOf("B"),
                "Private Network Monitoring (PNM) provides visibility and threat detection for the on-premises network, delivered from the cloud as a SaaS solution. It works by deploying lightweight software in a virtual machine or server that can consume a variety of native sources of telemetry or extract metadata from network packet flow. It encrypts this metadata and sends it to the Stealthwatch Cloud analytics platform for analysis. Stealthwatch Cloud consumes metadata only. The packet payloads are never retained or transferred outside the network.",
                "CCNP and CCIE Security Core SCOR 350-701 Official Cert Guide",
                QuestionCategory.SCOR_PART_3
            ),
            Question.MultipleChoice(
                ...
                setOf("D"),
                "As the organization does not have a local VM so the best solution is using FMC over the cloud. FMC can be deployed as a physical or virtual appliance, or from the cloud. It can also be consumed as a service. The cloud-delivered FMC, through CDO, has all the benefits of FMC without the need to manage FMC software update itself.",
                "CCNP and CCIE Security Core SCOR 350-701 Official Cert Guide",
                QuestionCategory.SCOR_PART_3
            ),
            Question.MultipleChoice(
            ...
            Question.MultipleChoice(
                ...
                setOf("A"),
                "Asymmetric encryption uses a pair of keys - a public key and a private key. The public key is used for encryption and can be shared freely, while the private key is used for decryption and must be kept secret.",
                "CCNP and CCIE Security Core SCOR 350-701 Official Cert Guide",
                QuestionCategory.SCOR_PART_3
            ),
            Question.MultipleChoice(
                ...
                setOf("A", "E"),
                "The following are restrictions for Flexible NetFlow: Both ingress and egress NetFlow accounting is supported. NetFlow supports multicast IP traffic and can be used to track MPLS traffic.",
                "CCNP and CCIE Security Core SCOR 350-701 Official Cert Guide",
                QuestionCategory.SCOR_PART_3
            ),
            Question.MultipleChoice(
            ...
            Question.MultipleChoice(
                ...
                setOf("A"),
                "The IP and Domain Reputation Center allows tracking the reputation of IP addresses for email and web traffic.",
                "CCNP and CCIE Security Core SCOR 350-701 Official Cert Guide",
                QuestionCategory.SCOR_PART_3
            ),
            Question.MultipleChoice(
                ...
                setOf("D"),
                "ESP (Encapsulating Security Payload) provides reliable authentication with ACK and sequence number support.",
                "CCNP and CCIE Security Core SCOR 350-701 Official Cert Guide",
                QuestionCategory.SCOR_PART_3
            ),
            Question.MultipleChoice(
                ...
                setOf("B"),
                "The command 'crypto isakmp key Cisco0123456789 172.19.20.24' configures the pre-shared key for ISAKMP authentication and restricts it to be used only with the specified IP address.",
                "CCNP and CCIE Security Core SCOR 350-701 Official Cert Guide",
                QuestionCategory.SCOR_PART_3
            ),
            Question.MultipleChoice(
            ...
            Question.MultipleChoice(
                ...
                setOf("C"),
                "To ensure the custom file policy is functioning correctly, you need to upload the hash for the file into the policy.",
                "CCNP and CCIE Security Core SCOR 350-701 Official Cert Guide",
                QuestionCategory.SCOR_PART_3
            ),
            Question.MultipleChoice(
                ...
                setOf("C"),
                "FlexVPN support multiple SAs and provides more efficient VPN establishment with less bandwidth consumption.",
                "CCNP and CCIE Security Core SCOR 350-701 Official Cert Guide",
                QuestionCategory.SCOR_PART_3
            ),
            Question.MultipleChoice(
                ...
                setOf("B"),
                "Cisco Workload Optimization Manager provides specific real-time actions that ensure workloads get the resources they need when they need them, enabling continuous placement, resizing, and capacity decisions that can be automated, driving continuous health in the environment.",
                "CCNP and CCIE Security Core SCOR 350-701 Official Cert Guide",
                QuestionCategory.SCOR_PART_3
            ),
            Question.MultipleChoice(
            ...
            Question.MultipleChoice(
                ...
                setOf("C"),
                "An exporter name is required when configuring a NetFlow exporter on a Cisco Router.",
                "CCNP and CCIE Security Core SCOR 350-701 Official Cert Guide",
                QuestionCategory.SCOR_PART_3
            ),
            Question.MultipleChoice(
                ...
                setOf("C"),
                "DoS (Denial of Service) attacks are a type of flood attack that aims to make a server unavailable to legitimate traffic by consuming all available server resources.",
                "CCNP and CCIE Security Core SCOR 350-701 Official Cert Guide",
                QuestionCategory.SCOR_PART_3
            ),
            Question.MultipleChoice(
                ...
                setOf("C", "E"),
                "Cisco AnyConnect allows customization of access policies based on user identity and enables VPN access for individual users from their machines.",
                "CCNP and CCIE Security Core SCOR 350-701 Official Cert Guide",
                QuestionCategory.SCOR_PART_3
            ),
            Question.MultipleChoice(
            ...
            Question.MultipleChoice(
                ...
                setOf("D"),
                "Data theft (exfiltration): Abuse of DNS to transfer data; this may be performed by tunneling other protocols like FTP, SSH through DNS queries and responses. Attackers make multiple DNS queries from a compromised computer to a domain owned by the adversary.",
                "CCNP and CCIE Security Core SCOR 350-701 Official Cert Guide",
                QuestionCategory.SCOR_PART_3
            )
        )
